...
namespace TestableConsoleApp.Shared.Models.Shared
{
    // Personificaçao de Void
    // Copia do Meaditr.Unit
    public readonly struct Nothing : IEquatable<Nothing>, IComparable<Nothing>, IComparable
    {
        private static readonly Nothing _value = new();

        /// <summary>
        /// Default and only value of the <see cref="Nothing"/> type.
        /// </summary>
        public static ref readonly Nothing Value => ref _value;

        /// <summary>
        /// Task from a <see cref="Nothing"/> type.
        /// </summary>
        public static Task<Nothing> Task { get; } = System.Threading.Tasks.Task.FromResult(_value);
